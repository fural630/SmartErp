...
//	private String scriptPath = SystemInfo.getScriptPath();
	...
	public static void main(String[] args) {
		CdiscountUtilDao cdiscountUtilDao = new CdiscountUtilDao();
		CdiscountBackstagePublishListingDao cdiscountBackstagePublishListingDao = new CdiscountBackstagePublishListingDao();
		Map<String, Object> queryMap = new HashMap<String, Object>();
		List<Integer> idList = new ArrayList<Integer>();
		idList.add(4);
		ServiceQueryHelper.and(queryMap, "id", idList, ServiceQueryHelper.IN);
		List<CdiscountBackstagePublishListing> listingList = cdiscountBackstagePublishListingDao.fetchList(queryMap);
		//				cdiscountUtilDao.packageCdiscountProduct(listingList);
		String offersXml = cdiscountUtilDao.createProductXml(listingList);
//		String offersXml = cdiscountUtilDao.createOffersXml(listingList);
	}
	
	public String packageCdiscountOffers(List<CdiscountBackstagePublishListing> publishListings) {
		...
		String offersXml = createOffersXml(publishListings);
	...
	public String packageCdiscountProduct(List<CdiscountBackstagePublishListing> publishListings) {
		if (CollectionUtils.isEmpty(publishListings)) {
			return null;
		}
		...
		String productXml = createProductXml(publishListings);
	...
	private String createProductXml (List<CdiscountBackstagePublishListing> backstagePublishListingList) {
	...
	private String createOffersXml(List<CdiscountBackstagePublishListing> publishListings) {
